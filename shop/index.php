...
<html>
   ...
   <body>
      <nav class="navbar position-sticky navbar-dark navbar-expand-sm textlight bg-dark navigation-clean">
         <div class="container">
...
if ($resultshop->num_rows > 0)
{
    ...
    {
        echo "<div class='col-12 col-lg-6 col-xl-5 mb-2'><div class='card text-white bg-dark'><div class='card-header'>" . $rowshop['item_stock'] . " " . $rowshop['item_name'] . "</div><div class='card-body'><img src='https://minecraftitemids.com/item/128/" . $rowshop['item_name'] . ".png'></img></div><div class='card-footer d-flex'><span>" . $rowshop['item_price'] . " diamants </span><a style='position: absolute; right: 15px;margin-top:6px' class='btn btn-success d-flex justify-content-end' href='../pay/?".$rowshop['id']."'>Acheter</a></div></div></div>";
    }
}
?>
            </div>
